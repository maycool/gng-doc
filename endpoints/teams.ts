...
class CreateTeam {
  @request
  request(
    @body body: CreateTeamsRequestBody,
    @headers headers: CreateTeamsRequestHeaders
  ) {}
...
class ListTeams {
  @request
  request(
    @headers headers: ListTeamsRequest,
    @queryParams queryParams: ListClubsPathParams
  ) {}
